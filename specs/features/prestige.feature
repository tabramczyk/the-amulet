Feature: Prestige System
  ...
  Scenario: Skill levels convert to prestige bonus
  ...
  Scenario: Job levels convert to prestige bonus
  ...
  Scenario: Prestige bonuses stack across lives
  ...
  Scenario: All progress resets except prestige on reincarnation
  ...
  Scenario: Prestige bonus applies to future XP gain
    Given the player has 20% prestige bonus for "strength"
